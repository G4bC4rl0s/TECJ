...
<div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-down">
    <h2 class="gradient-text fw-bold">
        <i class="fas fa-heart me-2 icon-bounce"></i>Vagas das Empresas que Sigo
    </h2>
    <div class="pulse-animation">
        <span class="badge" style="background: var(--secondary); font-size: 1rem;">
            <i class="fas fa-briefcase me-1"></i>{{ $jobs->total() ?? 0 }} Vagas
        </span>
    </div>
</div>
                        ...
                        <div class="mb-3">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    ...
                                    <h6 class="text-muted mb-0">{{ $job->company->name }}</h6>
                                </div>
                            </div>
                        </div>
...
@else
    <div class="card" data-aos="fade-up">
        <div class="card-body text-center py-5">
            ...
            <p class="text-muted mb-4">Você ainda não segue nenhuma empresa ou elas não têm vagas ativas.</p>
            <div class="d-flex gap-3 justify-content-center">
                <a href="{{ route('companies.index') }}" class="btn btn-primary pulse-animation">
